...
public class HappyActivity extends AppCompatActivity {
    ...
    private HappyPaintView paintView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(HappyActivity.this, TotalActivity.class);
                finish();
                startActivity(i);
            }
        });
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ActivityCompat.requestPermissions(HappyActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.save_button:
                        ...
                        if (ContextCompat.checkSelfPermission(HappyActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void openColourPicker () {
        ...
        AmbilWarnaDialog ambilWarnaDialog = new AmbilWarnaDialog(this, defaultColor, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            ...
            public void onCancel(AmbilWarnaDialog dialog) {
                ...
                Toast.makeText(HappyActivity.this, "Unavailable", Toast.LENGTH_LONG).show();
